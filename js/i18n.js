...
const T = {
  ar: {
    ...
    branchLabel: "الفرع:",
    createInvoice: "طباعة فاتورة مشتريات",
    printInventoryReport: "طباعة الفاتورة",
    printInventoryReportLong: "طباعة تقرير جرد وتسليم منتجات",
    shareTitle: "مشاركة الفاتورة",
    shareGenerating: "جاري إنشاء الفاتورة...",
    sharePreparing: "جاري تجهيز الملف للمشاركة...",
    shareReadyTitle: "الفاتورة جاهزة",
    shareReadyMsg: "تم إنشاء ملف PDF بنجاح. اضغط مشاركة لتظهر لك التطبيقات (ومنها واتساب)، أو حمّل الملف لتشاركه يدوياً.",
    shareBtn: "مشاركة",
    shareFallbackTitle: "المشاركة غير مدعومة",
    shareFallbackMsg: "متصفحك لا يدعم مشاركة الملفات مباشرة. يمكنك تحميل ملف PDF ثم مشاركته يدوياً عبر WhatsApp.",
    shareDownload: "تحميل ملف PDF",
    shareErrorTitle: "حدث خطأ",
    shareFailureMsg: "حدث خطأ أثناء إنشاء الفاتورة أو تجهيزها للمشاركة. الرجاء المحاولة مرة أخرى.",
    rptTitleAr: "تقرير جرد وتسليم منتجات",
    rptTitleEn: "Products Inventory & Delivery Report",
    rptSubHeaderAr: "تقرير جرد وتسليم منتجات",
    rptSubHeaderEn: "Products Inventory & Delivery Report",
    rptColNoAr: "م",
    rptColNoEn: "No.",
    rptColProductAr: "المنتج",
    rptColProductEn: "Product",
    rptColCategoryAr: "القسم",
    rptColCategoryEn: "Category",
    rptColRequestedAr: "عدد المنتجات التي طلبها الفرع",
    rptColRequestedEn: "Number of Products Requested by Branch",
    rptColDeliveredAr: "عدد المنتجات المسلمة للفرع",
    rptColDeliveredEn: "Number of Products Delivered to Branch",
    rptColAvailableAr: "عدد المنتجات الموجودة بالفرع بعد التسليم",
    rptColAvailableEn: "Number of Products Available in Branch After Delivery",
    rptColExpiredAr: "عدد المنتجات المنتهية الصلاحية",
    rptColExpiredEn: "Number of Expired Products",
    rptColNoExpiryAr: "عدد المنتجات التي لا تحمل تاريخ صلاحية",
    rptColNoExpiryEn: "Number of Products Without Expiry Date",
    rptColNearExpiryAr: "عدد المنتجات التي بقي على صلاحيتها أقل من أسبوع",
    rptColNearExpiryEn: "Number of Products with Less Than One Week Until Expiry",
    rptDeliveryDateAr: "تاريخ التسليم والجرد",
    rptDeliveryDateEn: "Delivery & Inventory Date",
    rptBranchMgrAr: "اسم مدير الفرع",
    rptBranchMgrEn: "Branch Manager Name",
    rptBranchInspAr: "اسم مفتش الفرع",
    rptBranchInspEn: "Branch Inspector Name",
    rptSignatureAr: "التوقيع",
    rptSignatureEn: "Signature",
    rptOrderDateAr: "تاريخ إنشاء التقرير",
    rptOrderDateEn: "Report Creation Date",
    rptUserAr: "اسم صاحب الطلب",
    rptUserEn: "Requester Name",
    rptBranchAr: "اسم الفرع",
    rptBranchEn: "Branch Name",
    rptNoProducts: "لا توجد منتجات",
    noExpiry: "No Expiry / بدون تاريخ صلاحية",
  ...
  en: {
    ...
    branchLabel: "Branch:",
    createInvoice: "Print Purchase Invoice",
    printInventoryReport: "Print Invoice",
    printInventoryReportLong: "Print Products Inventory & Delivery Report",
    shareTitle: "Share invoice",
    shareGenerating: "Creating invoice...",
    sharePreparing: "Preparing file for sharing...",
    shareReadyTitle: "Invoice ready",
    shareReadyMsg: "PDF file created successfully. Tap Share to open apps (including WhatsApp), or download the file to share it manually.",
    shareBtn: "Share",
    shareFallbackTitle: "Sharing not supported",
    shareFallbackMsg: "Your browser does not support direct file sharing. You can download the PDF and share it manually via WhatsApp.",
    shareDownload: "Download PDF",
    shareErrorTitle: "Error",
    shareFailureMsg: "An error occurred while creating or preparing the invoice. Please try again.",
    rptTitleAr: "تقرير جرد وتسليم منتجات",
    rptTitleEn: "Products Inventory & Delivery Report",
    rptSubHeaderAr: "Products Inventory & Delivery Report",
    rptSubHeaderEn: "Products Inventory & Delivery Report",
    rptColNoAr: "No.",
    rptColNoEn: "No.",
    rptColProductAr: "Product",
    rptColProductEn: "Product",
    rptColCategoryAr: "Category",
    rptColCategoryEn: "Category",
    rptColRequestedAr: "Number of Products Requested by Branch",
    rptColRequestedEn: "Number of Products Requested by Branch",
    rptColDeliveredAr: "Number of Products Delivered to Branch",
    rptColDeliveredEn: "Number of Products Delivered to Branch",
    rptColAvailableAr: "Number of Products Available in Branch After Delivery",
    rptColAvailableEn: "Number of Products Available in Branch After Delivery",
    rptColExpiredAr: "Number of Expired Products",
    rptColExpiredEn: "Number of Expired Products",
    rptColNoExpiryAr: "Number of Products Without Expiry Date",
    rptColNoExpiryEn: "Number of Products Without Expiry Date",
    rptColNearExpiryAr: "Number of Products with Less Than One Week Until Expiry",
    rptColNearExpiryEn: "Number of Products with Less Than One Week Until Expiry",
    rptDeliveryDateAr: "Delivery & Inventory Date",
    rptDeliveryDateEn: "Delivery & Inventory Date",
    rptBranchMgrAr: "Branch Manager Name",
    rptBranchMgrEn: "Branch Manager Name",
    rptBranchInspAr: "Branch Inspector Name",
    rptBranchInspEn: "Branch Inspector Name",
    rptSignatureAr: "Signature",
    rptSignatureEn: "Signature",
    rptOrderDateAr: "Report Creation Date",
    rptOrderDateEn: "Report Creation Date",
    rptUserAr: "Requester Name",
    rptUserEn: "Requester Name",
    rptBranchAr: "Branch Name",
    rptBranchEn: "Branch Name",
    rptNoProducts: "No products",
    noExpiry: "No Expiry / بدون تاريخ صلاحية",
...
export function applyCartLang(){
  ...
  setLabel(document.getElementById("printInventoryReport"), t("printInventoryReport"));
  ...
  const printInvMob=document.getElementById("printInventoryReportMobile");
  if(printInvMob)printInvMob.querySelector("span").textContent=t("printInventoryReport");
